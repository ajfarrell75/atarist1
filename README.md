...
| *Machine → MIDI OUT* | Built-in GM synth, Roland MT-32/CM-32L (Munt, ROMs in `roms/mt32/`), real hardware devices, or a virtual port (macOS/Linux; on Windows install loopMIDI) |
