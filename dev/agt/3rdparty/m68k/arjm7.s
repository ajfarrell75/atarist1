...
;
		...
		.if	(^^defined AGT_CONFIG_PACKER_ARJ7 | ^^defined AGT_CONFIG_PACKER_ANY)
...
;	move.l		.usize(a6),d0
	move.l		.psrc(a6),a1
	move.l		.pdst(a6),a0
	move.l		(a1)+,d0	; unpacked size in arjblob header
	addq.l		#4,a1	
*-------------------------------------------------------*
...
*-------------------------------------------------------*
	...
	.endif ; (^^defined AGT_CONFIG_PACKER_ARJ7 | ^^defined AGT_CONFIG_PACKER_ANY)
