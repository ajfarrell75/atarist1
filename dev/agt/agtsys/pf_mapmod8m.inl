...
agt_inline void PQRS8m_dirty_block_direct(s16 _mi, s16 _mj, s16 pi, s16 pj, s16 pi2, s16 pj2)
{
	// likely to be deprecated
}

agt_inline void PQ8m_dirty_block_direct(s16 _mi, s16 _mj, s16 pi, s16 pj, s16 pi2, s16 pj2)
{						
	// likely to be deprecated
}

agt_inline void PR8m_dirty_block_direct_(s16 _mi, s16 _mj, s16 pi, s16 pj, s16 pi2, s16 pj2)
{						
	...
	const u16* ptiles = &tiledata_[2*8];
	const u16* ptilesoverlay = &tileoverlaydata_[2*2*8];
...
agt_inline void PR8m_dirty_block_direct(s16 _mi, s16 _mj, s16 pi, s16 pj, s16 pi2, s16 pj2)
{
...
//	if (pipart > pi)
	{
		...
		// left
		PR8m_dirty_block_direct_(_mi, _mj, pi, pj, pipart, pj2);
		// right
		PR8m_dirty_block_direct_(mipart, _mj, pipart, pj, pi2, pj2);
	}
	else
	{
		// single block is enough
		PR8m_dirty_block_direct_(_mi, _mj, pi, pj, pi2, pj2);
	}
}

agt_inline void P8m_dirty_block_direct(s16 _mi, s16 _mj, s16 pi, s16 pj, s16 pi2, s16 pj2)
{						
	// likely to be deprecated
}
