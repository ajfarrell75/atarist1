...
.macro	tile_p		offs,dst,src,dstpgw,dstpgh,tdst,tsrc
...
*------------------------------------------------------------------------------*
_do_dirtyrect_p:	.globl	_do_dirtyrect_p
*------------------------------------------------------------------------------*
...
.macro	jtile_p		offs,dst,src,dstpgw,dstpgh,tdst,tsrc,mapsrc,tilesrc
	...
	tile_p		\offs,\dst,\src,\dstpgw,\dstpgh,\tdst,\tsrc
...
.do_block_1111:
	jtile_p		-4,a4,d0,d7,d6,a3,a5,a0,a2
.do_block_0111:
	jtile_p		-3,a4,d0,d7,d6,a3,a5,a0,a2
.do_block_0011:
	jtile_p		-2,a4,d0,d7,d6,a3,a5,a0,a2
.do_block_0001:
	jtile_p		-1,a4,d0,d7,d6,a3,a5,a0,a2
	lea		-4*4(a0),a0
	lea		-4*8(a4),a4	
	rts	
