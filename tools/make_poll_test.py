#!/usr/bin/env python3
# Test de poll $FF8209 : handler HBL lit le compteur vidéo bas et le pose en
# palette[0] → chaque scanline a une couleur = f(compteur à son HBL). Le motif
# de barres encode la datation CPU↔faisceau, comparable NeoST↔Hatari au pixel.
...
out = sys.argv[1] if len(sys.argv) > 1 else "/tmp/poll.st"
