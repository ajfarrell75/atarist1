...
constexpr uint8_t WR5_RTS = 0x02, WR5_TX_ENABLE = 0x08, WR5_SEND_BREAK = 0x10, WR5_DTR = 0x80;
// WR4 stop bits
...
// WR15
constexpr uint8_t WR15_WR7_PRIME = 0x01, WR15_ZERO_COUNT_IE = 0x02, WR15_STATUS_FIFO = 0x04,
